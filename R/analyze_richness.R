...
dfilt_code <- ifelse(filt_dates, str_c(date_range, collapse = 'to'), 'alldates')
...
pred_dir <- file.path('data', 'data_out', 'sdm', rf_name, name)
pred_dir <- file.path('data', 'data_out', 'sdm', rf_name)
